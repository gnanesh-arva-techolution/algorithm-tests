...
import static com.techolution.algorithms.InTheFuture.minNum;
...
public class InTheFutureTest {
    ...
    @Test
    public void minNum_Test() throws Exception {
        List<TestCase> testCases = new ArrayList<>();
        File folder = new File(TEST_DATA_PATH + "In The Future");
        ...
        printTestCasesStatus(testCases, "In The Future");
